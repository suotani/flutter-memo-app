...
class _$NoteTearOff {
  ...
  _Note call({required int id, required String title}) {
    return _Note(
      id: id,
      title: title,
    );
...
class _$_Note implements _Note {
  const _$_Note({required this.id, required this.title});
...
abstract class _Note implements Note {
  const factory _Note({required int id, required String title}) = _$_Note;
